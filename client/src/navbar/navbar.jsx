            ...
            </MDBNavbarNav>
            {
              localStorage.getItem("userId")
                ? (<><MDBDropdown group className='shadow-0'>
                  <MDBDropdownToggle color='light'><i className='fa fa-user'></i>  Hi! {localStorage.getItem("username")}</MDBDropdownToggle>
                  <MDBDropdownMenu>
                    <MDBDropdownItem>
                ...
                : (<><MDBDropdown group className='shadow-0'>
                  <MDBDropdownToggle color='light'><i className='fa fa-user'></i>  Account</MDBDropdownToggle>
                  <MDBDropdownMenu>
                    <MDBDropdownItem>
